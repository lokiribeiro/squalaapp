  ...
  constructor($rootScope, $scope, $mdToast, $timeout, $element, $q, $mdSidenav, $log, $mdDialog, $state, Upload){
      ...
      users(){
        ...
        userBalances.forEach(function(userBalance) {
          ...
          var counter = userBalance.transactions.length;
          console.info('counter', counter);
          for(i=0;i<counter;i++){
            $scope.balanceLeft = userBalance.transactions[i].balance;
          }
        } else {
          $scope.balanceLeft = 0;
        }
...
app.component('balance', {
    templateUrl: 'client/components/headmasterProfile/headmasterCollect/balance/balance.html',
