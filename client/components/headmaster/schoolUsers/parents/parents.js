...
class SchoolparentsCtrl{
  ...
  constructor($scope, $timeout, $mdSidenav, $element, $log, $mdDialog, $state, $q, $mdToast, $rootScope){
      ...
      $scope.subscribe('profilesParent', function () {
      ...
      $scope.openProfile2 = function (selected5) {
        console.info('selected:', selected5[0].profiles_userID);
        var profileID = selected5[0].profiles_userID;
...
app.component('schoolparents', {
    templateUrl: 'client/components/headmaster/schoolUsers/parents/parents.html',
    controllerAs: 'schoolparents',
    controller: SchoolparentsCtrl,
    transclude: true
})
