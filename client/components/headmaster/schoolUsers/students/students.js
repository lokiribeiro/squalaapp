...
app.component('schoolstudents', {
    templateUrl: 'client/components/headmaster/schoolUsers/students/students.html',
    controllerAs: 'schoolstudents',
    controller: SchoolstudentsCtrl,
    transclude: true
})
