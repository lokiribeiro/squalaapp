...
class SchoolstaffCtrl{
  ...
  constructor($scope, $timeout, $mdSidenav, $element, $log, $mdDialog, $state, $q, $mdToast, $rootScope){
      ...
      $scope.subscribe('profilesStaff', function () {
...
app.component('schoolstaff', {
    templateUrl: 'client/components/headmaster/schoolUsers/schoolStaff/schoolstaff.html',
    controllerAs: 'schoolstaff',
    controller: SchoolstaffCtrl,
    transclude: true
})
