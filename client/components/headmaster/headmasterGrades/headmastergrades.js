...
app.component('headmastergrades', {
    templateUrl: 'client/components/headmaster/headmasterGrades/headmastergrades.html',
    controllerAs: 'headmastergrades',
    controller: HeadmastergradesCtrl
})
