...
app.component('branchschools', {
    templateUrl: 'client/components/headmaster/branchschools/branchschools.html',
    controllerAs: 'branchschools',
    controller: BranchschoolsCtrl,
    transclude: true
})
