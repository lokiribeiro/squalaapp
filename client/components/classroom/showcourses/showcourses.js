...
class ShowcoursesCtrl{
  ...
  constructor($scope, $timeout, $mdSidenav, $log, $mdDialog, $state, $q){
      ...
      $scope.openDialog = function ($event, selected) {
          $scope.courseDel = selected[0]._id;
...
app.component('showcourses', {
    templateUrl: 'client/components/classroom/showcourses/showcourses.html',
    controllerAs: 'showcourses',
