...
app.component('classstream', {
    templateUrl: 'client/components/classroom/virtualclassroom/classstream/classstream.html',
    controllerAs: 'classstream',
    controller: ClassstreamCtrl
})
