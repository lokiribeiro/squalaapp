...
app.component('classroomresources', {
    templateUrl: 'client/components/classroom/classroomresources/classroomresources.html',
    controllerAs: 'classroomresources',
    controller: ClassroomresourcesCtrl
})
