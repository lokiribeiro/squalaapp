...
class ApplicationschoolinfoCtrl{
...
app.component('applicationschoolinfo', {
    templateUrl: 'client/components/admissions/applicationschoolinfo/applicationschoolinfo.html',
    controllerAs: 'applicationschoolinfo',
    controller: ApplicationschoolinfoCtrl
})
